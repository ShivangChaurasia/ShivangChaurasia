...
<div align="center">
  ...
  <a href="https://leetcode.com/shiva17ng/">
    <img src="https://img.shields.io/badge/LeetCode-shiva17ng-000000?style=for-the-badge&logo=leetcode&logoColor=white" alt="LeetCode" />
  </a>
  ...
  <a href="https://shivangchaurasia.vercel.app/">
    <img src="https://img.shields.io/badge/Portfolio-shivangchaurasia.vercel.app-000000?style=for-the-badge&logo=vercel&logoColor=white" alt="Portfolio" />
  </a>
</div>
...
### Ⅰ. IDENTITY & PHILOSOPHY

I am a 3rd-Year B.Tech CSE student operating as a System Architect and Full-Stack Developer. My focus is on engineering scalable infrastructures and designing precise, resilient software ecosystems.
...
| :--- | :--- | :--- |
| **LeaveOrbit** | Full-stack organizational network. | `MERN` `Google OAuth` `Real-Time Analytics` |
| **AspireLens** | Secure trajectory & guidance engine. | `MERN` `JWT Auth` `Role-Based Access` |
| **SafeFolder** | Privacy-first local file ecosystem. | `iOS` `SwiftUI` `MVVM Pattern` |
| **BMI Calculator** | Fluid kinetic interface. | `JavaScript` `Tailwind CSS` `Lottie` |
